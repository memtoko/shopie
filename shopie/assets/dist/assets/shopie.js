...
define('shopie/components/sh-form-group', ['exports', 'shopie/components/sh-validation-status-container'], function (exports, ValidationStatusContainer) {
...
define('shopie/components/sh-spin-button', ['exports', 'ember'], function (exports, Ember) {
...
define('shopie/components/sh-validation-status-container', ['exports', 'ember', 'shopie/mixins/validation-state'], function (exports, Ember, ValidationStateMixin) {
...
define('shopie/controllers/application', ['exports', 'ember'], function (exports, Ember) {
    ...
    exports['default'] = Ember['default'].Controller.extend({
        ...
        // jscs: disable
        signedOut: Ember['default'].computed.match('currentPath', /(login|signup|setup|reset)/),
        // jscs: enable
        showCart: false,
...
define('shopie/controllers/login', ['exports', 'ember', 'shopie/mixins/validation-engine', 'ic-ajax'], function (exports, Ember, ValidationEngine, ic_ajax) {
    ...
    exports['default'] = Ember['default'].Controller.extend(ValidationEngine['default'], {
        ...
        shopiePaths: Ember['default'].inject.service('shopie-paths'),
        notifications: Ember['default'].inject.service(),
        flowErrors: '',
        ...
        actions: {
            authenticate: function authenticate() {
                ...
                var authStrategy = 'shopie-authenticator:oauth2-password-grant';

                this.get('session').authenticate(authStrategy, data)['catch'](function (err) {
                    _this.toggleProperty('loggingIn');
                    if (err.error) {
                        _this.set('flowErrors', err.error + ': ' + err.error_description);
                    }
                });
            },
            ...
            validateAndAuthenticate: function validateAndAuthenticate() {
                ...
                this.validate({ property: 'login' }).then(function () {
                    _this2.toggleProperty('loggingIn');
                    _this2.send('authenticate');
                })['catch'](function (error) {
                    if (error) {
                        _this2.get('notifications').showAPIError(error, { key: 'login.authenticate' });
                    } else {
...
define('shopie/initializers/ember-cli-fastclick', ['exports', 'ember'], function (exports, Ember) {
...
define('shopie/initializers/ember-simple-auth', ['exports', 'ember', 'shopie/config/environment', 'ember-simple-auth/configuration', 'ember-simple-auth/initializers/setup-session', 'ember-simple-auth/initializers/setup-session-service'], function (exports, Ember, ENV, Configuration, setupSession, setupSessionService) {
...
define('shopie/initializers/simple-auth-env', ['exports', 'shopie/config/environment'], function (exports, ENV) {
    ...
    exports['default'] = {
        ...
        initialize: function initialize() {
            ...
            ENV['default']['simple-auth-oauth2'].serverTokenRevocationEndpoint = '/o/revoke_token/';
...
define('shopie/instance-initializers/ember-simple-auth', ['exports', 'ember-simple-auth/instance-initializers/setup-session-restoration'], function (exports, setupSessionRestoration) {
...
define('shopie/libs/validators/login', ['exports', 'shopie/libs/validators/base'], function (exports, BaseValidator) {
    ...
    exports['default'] = BaseValidator['default'].create({
        properties: ['identification', 'login', 'forgotPassword'],
...
define('shopie/libs/validators/signup', ['exports', 'shopie/libs/validators/new-user'], function (exports, NewUserValidator) {
...
define('shopie/mixins/validation-engine', ['exports', 'ember', 'ember-data', 'shopie/utils/ajax', 'shopie/utils/validator-extensions', 'shopie/libs/validators/login', 'shopie/libs/validators/new-user'], function (exports, Ember, DS, getRequestErrorMessage, ValidatorExtensions, loginValidator, newUserValidator) {
...
define('shopie/mixins/validation-state', ['exports', 'ember'], function (exports, Ember) {
...
define('shopie/models/cart-item', ['exports', 'ember-data'], function (exports, DS) {
    ...
    exports['default'] = DS['default'].Model.extend({
        ...
        cart: DS['default'].belongsTo('cart', { async: true }),
...
define('shopie/routes/signup', ['exports', 'ember'], function (exports, Ember) {
...
define('shopie/services/session', ['exports', 'ember-simple-auth/services/session'], function (exports, SessionService) {
...
define('shopie/session-stores/application', ['exports', 'ember-simple-auth/session-stores/adaptive'], function (exports, Adaptive) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","unless",[["get","signedOut",["loc",[null,[4,14],[4,23]]]]],[],0,null,["loc",[null,[4,4],[8,15]]]],
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child3 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","link-to",["login"],[],0,null,["loc",[null,[21,20],[21,58]]]]
        ],
        locals: [],
        templates: [child0]
      };
...
define('shopie/templates/components/sh-spin-button', ['exports'], function (exports) {
    ...
    var child0 = (function() {
      return {
        meta: {
          ...
          "moduleName": "shopie/templates/components/sh-spin-button.hbs"
        },
        isEmpty: false,
        arity: 0,
        cachedFragment: null,
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        statements: [
          ["inline","sh-trim-focus-input",[],["class","sh-input email","type","email","placeholder","Email Address","name","identification","autocapitalize","off","autocorrect","off","tabindex","1","focusOut",["subexpr","action",["validate","identification"],[],["loc",[null,[7,193],[7,229]]]],"value",["subexpr","@mut",[["get","model.identification",["loc",[null,[7,236],[7,256]]]]],[],[]]],["loc",[null,[7,24],[7,258]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child1 = (function() {
      ...
      return {
        ...
        statements: [
          ["inline","sh-input",[],["class","password","type","password","placeholder","Password","name","password","tabindex","2","value",["subexpr","@mut",[["get","model.password",["loc",[null,[12,126],[12,140]]]]],[],[]],"autocorrect","off"],["loc",[null,[12,24],[12,160]]]],
          ["block","sh-spin-button",[],["class","forgotten-link btn btn-link","type","button","action","forgotten","tabindex","4","submitting",["subexpr","@mut",[["get","submitting",["loc",[null,[13,135],[13,145]]]]],[],[]],"autoWidth","true"],0,null,["loc",[null,[13,24],[13,190]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    var child2 = (function() {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          var el0 = dom.createDocumentFragment();
          var el1 = dom.createTextNode("Login in");
          dom.appendChild(el0, el1);
          return el0;
        },
        buildRenderNodes: function buildRenderNodes() { return []; },
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        var el0 = dom.createDocumentFragment();
        var el1 = dom.createElement("div");
        dom.setAttribute(el1,"class","sh-flow");
        var el2 = dom.createTextNode("\n    ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","sh-flow-content-wrap");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("section");
        dom.setAttribute(el3,"class","sh-flow-content");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("form");
        dom.setAttribute(el4,"id","login");
        dom.setAttribute(el4,"class","sh-signin");
      ...
      statements: [
        ["block","sh-form-group",[],["errors",["subexpr","@mut",[["get","model.errors",["loc",[null,[5,40],[5,52]]]]],[],[]],"hasValidated",["subexpr","@mut",[["get","hasValidated",["loc",[null,[5,66],[5,78]]]]],[],[]],"property","identification"],0,null,["loc",[null,[5,16],[9,34]]]],
        ["block","sh-form-group",[],["errors",["subexpr","@mut",[["get","model.errors",["loc",[null,[10,40],[10,52]]]]],[],[]],"hasValidated",["subexpr","@mut",[["get","hasValidated",["loc",[null,[10,66],[10,78]]]]],[],[]],"property","password"],1,null,["loc",[null,[10,16],[15,34]]]],
        ["block","sh-spin-button",[],["class","login btn btn-blue btn-block","type","submit","action","validateAndAuthenticate","tabindex","3","submitting",["subexpr","@mut",[["get","loggingIn",["loc",[null,[16,142],[16,151]]]]],[],[]],"autoWidth","false"],2,null,["loc",[null,[16,16],[16,198]]]],
...
define('shopie/tests/components/sh-form-group.jshint', function () {

  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/sh-form-group.js should pass jshint', function(assert) { 
    assert.ok(true, 'components/sh-form-group.js should pass jshint.'); 
  });
...
define('shopie/tests/components/sh-spin-button.jshint', function () {

  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/sh-spin-button.js should pass jshint', function(assert) { 
    assert.ok(true, 'components/sh-spin-button.js should pass jshint.'); 
  });
...
define('shopie/tests/components/sh-validation-status-container.jshint', function () {

  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/sh-validation-status-container.js should pass jshint', function(assert) { 
    assert.ok(true, 'components/sh-validation-status-container.js should pass jshint.'); 
  });
...
define('shopie/tests/helpers/ember-simple-auth', ['exports', 'ember-simple-auth/authenticators/test'], function (exports, Test) {
...
define('shopie/tests/libs/validators/signup.jshint', function () {

  'use strict';

  QUnit.module('JSHint - libs/validators');
  QUnit.test('libs/validators/signup.js should pass jshint', function(assert) { 
    assert.ok(true, 'libs/validators/signup.js should pass jshint.'); 
  });
...
define('shopie/tests/mixins/validation-state.jshint', function () {

  'use strict';

  QUnit.module('JSHint - mixins');
  QUnit.test('mixins/validation-state.js should pass jshint', function(assert) { 
    assert.ok(true, 'mixins/validation-state.js should pass jshint.'); 
  });
...
define('shopie/tests/routes/signup.jshint', function () {
...
define('shopie/tests/utils/validator-extensions.jshint', function () {

  'use strict';

  QUnit.module('JSHint - utils');
  QUnit.test('utils/validator-extensions.js should pass jshint', function(assert) { 
    assert.ok(true, 'utils/validator-extensions.js should pass jshint.'); 
  });
        ...
        return {
            ...
            url: {
                ...
                oauth2: function oauth2() {
                    return makeRoute(oauth2Root, _arguments);
                },
...
define('shopie/utils/validator-extensions', ['exports', 'ember'], function (exports, Ember) {
...
if (runningTests) {
  ...
  require("shopie/app")["default"].create({"API_HOST":null,"API_NAMESPACE":"api/v1"});
}
